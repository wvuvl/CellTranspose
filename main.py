...
# results_dir = '/home/matthew/Documents/Datasets/Neuro_Proj1_Data/2D Toy Dataset - 2-dim/results/results_1'
results_dir = '/home/matthew/Documents/Datasets/Neuro_Proj1_Data/2D Toy Dataset - 3-dim/results/results_6'
...
gen_cellpose.load_state_dict(load('/home/matthew/Documents/Datasets/Neuro_Proj1_Data/cellpose_models/trained_model.pt'))
...
gen_size_model.load_state_dict(load('/home/matthew/Documents/Datasets/Neuro_Proj1_Data/cellpose_models/size_model.pt'))
...
train_dataset = StandardizedTiffData('/home/matthew/Documents/Datasets/Neuro_Proj1_Data/2D Toy Dataset - 3-dim',
...
#                                    # default_meds=default_meds)
val_dataset = StandardizedTiffData('/home/matthew/Documents/Datasets/Neuro_Proj1_Data/2D Toy Dataset - 2-dim',
                                   do_3D=False, d_transform=data_transform, l_transform=label_transform)
                                   # default_meds=default_meds)
...
if do_adaptation:
    ...
    #                                       )
    target_dataset = StandardizedTiffData('/home/matthew/Documents/Datasets/Neuro_Proj1_Data/2D Toy Dataset - 2-dim',
                                          do_3D=False, d_transform=data_transform, l_transform=label_transform,
                                          # augmentations=augmentations
                                          )
...
if do_adaptation:
    train_losses = adapt_network(model, train_dl, train_dl, default_diams, optimizer=optimizer, device=device,
